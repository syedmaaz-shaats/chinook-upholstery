    ...
    <>
      ...
      <section className="bg-white py-24 px-6 md:px-16 lg:px-32">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#002f61] mb-4">
              Get in Touch
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              {status === "sent" && (
                <p className="text-[#002f61]-600 mt-4 font-medium">Message sent successfully!</p>
              )}
              {status === "error" && (
